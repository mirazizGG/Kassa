...
Tugagach: `http://SERVER-IP:8000`, login `miraziz` / `8038434` (**darhol o'zgartiring**).
...
Login: `miraziz` / `8038434` — **darhol parolni o'zgartiring** (Xodimlar bo'limida).
...
- [ ] `miraziz` / `8038434` paroli o'zgartirilgan
