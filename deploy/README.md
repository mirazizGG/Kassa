...
Tugagach: `http://SERVER-IP:8000`, login `miraziz` / `changeme-dev` (**darhol o'zgartiring**).
...
Login: `miraziz` / `changeme-dev` — **darhol parolni o'zgartiring** (Xodimlar bo'limida).
...
- [ ] `miraziz` / `changeme-dev` paroli o'zgartirilgan
