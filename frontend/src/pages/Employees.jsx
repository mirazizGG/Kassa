      ...
      <div className="rounded-2xl border bg-gradient-to-r from-primary/10 via-background to-background p-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Jamoa boshqaruvi va topshiriqlar nazorati
          </p>
        </div>
      </div>
      ...
      <Tabs defaultValue="list" className="w-full">
        <TabsList className="grid w-full grid-cols-3 max-w-[500px]">
          ...
          <TabsTrigger value="tasks" className="gap-2">
            <CheckSquare className="w-4 h-4" /> Vazifalar
          </TabsTrigger>
          <TabsTrigger value="performance" className="gap-2">
            <TrendingUp className="w-4 h-4" /> Samaradorlik
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="list" className="mt-6">
              ...
              <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleCreateEmployee}>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Tizimga kirishi uchun yangi xodim yarating
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Select
                        ...
                        onValueChange={(v) =>
                          setNewEmployee({ ...newEmployee, role: v })
                        }
                      >
                        <SelectTrigger>
          ...
          <Card className="overflow-hidden border shadow-sm bg-card">
            <CardHeader>
              ...
              <CardDescription>
                Admin, Manager va Kassirlar ro'yxati
              </CardDescription>
            </CardHeader>
                ...
                <TableBody>
                  {isEmployeesLoading ? (
                    ...
                    employees.map((emp) => (
                      <TableRow
                        key={emp.id}
                        className="group hover:bg-muted/50 transition-colors odd:bg-muted/10"
                      >
                        ...
                        <TableCell>
                          <span
                            className={`flex items-center gap-2 text-sm font-medium ${emp.is_active ? "text-emerald-500" : "text-rose-500"}`}
                          >
                            <div
                              className={`w-2 h-2 rounded-full ${emp.is_active ? "bg-emerald-500" : "bg-rose-500"}`}
                            />
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {emp.username !== "miraziz" &&
                                ...
                                <DropdownMenuItem
                                  ...
                                  className={
                                    emp.is_active
                                      ? "text-amber-600 focus:text-amber-600 font-medium"
                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        required
                        placeholder="Masalan: Omborini tartiblash"
                      />
                    </div>
                    <div className="grid gap-2">
                ...
                >
                  ...
                  <CardContent>
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mt-2">
                      ...
                      {employees.find((e) => e.id === task.assigned_to)
                        ?.full_name || "Noma'lum"}
                    </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {isPerformanceLoading ? (
              ...
              performance.map((emp) => (
                <Card
                  key={emp.id}
                  className="border-none shadow-md bg-background/60 backdrop-blur-xl transition-all hover:shadow-lg"
                >
                  <CardHeader className="pb-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-2 w-full bg-secondary rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${emp.total_tasks > 0 ? (emp.completed_tasks / emp.total_tasks) * 100 : 0}%`,
                          }}
                        />
                      </div>
                    </div>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <form onSubmit={handleUpdateEmployee}>
            <DialogHeader>
              ...
              <DialogDescription>
                Mavjud xodim ma'lumotlarini yangilang
              </DialogDescription>
            </DialogHeader>
            {editingEmployee && (
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Input
                      id="edit-passport"
                      value={editingEmployee.passport || ""}
                      onChange={(e) =>
                        setEditingEmployee({
                          ...editingEmployee,
                          passport: e.target.value,
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="grid gap-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setEditingEmployee({ ...editingEmployee, role: v })
                      }
                      disabled={
                        editingEmployee.id === currentUserId ||
                        (role === "manager" &&
                          editingEmployee.role !== "cashier")
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                    ...
                    {role === "manager" &&
                      editingEmployee.role !== "cashier" && (
                        <span className="text-[10px] text-amber-600 font-medium">
                          Faqat kassirlarni boshqara olasiz
                        </span>
                      )}
                  </div>
                  <div className="grid gap-2">
                    ...
                    {role === "manager" &&
                      editingEmployee.role !== "cashier" && (
                        <span className="text-[10px] text-amber-600 font-medium">
                          Faqat kassirlarni bloklay olasiz
                        </span>
                      )}
                  </div>
                </div>
      ...
      <Dialog open={isDeleteConfirmOpen} onOpenChange={setIsDeleteConfirmOpen}>
        <DialogContent className="sm:max-w-[400px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Haqiqatdan ham <b>{deletingEmployee?.full_name}</b>ni tizimdan
              o'chirib tashlamoqchimisiz? Bu amalni ortga qaytarib bo'lmaydi.
            </DialogDescription>
          </DialogHeader>
