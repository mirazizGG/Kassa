...
const Settings = () => {
  ...
  useEffect(() => {
    if (settings) {
      // The query result hydrates this editable form after it loads.
  ...
  const mutation = useMutation({
    ...
    onError: (err) => {
      toast.error("Xatolik!", {
        description: err.response?.data?.detail || "Saqlab bo'lmadi",
      });
    },
  });
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="rounded-2xl border bg-gradient-to-r from-primary/10 via-background to-background p-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Do'kon ma'lumotlari va kvitansiya (check) dizaynini sozlash
          </p>
        </div>
      </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="border shadow-sm bg-card">
            <CardHeader>
              ...
              <CardDescription>
                Mijozlarga ko'rinadigan asosiy ma'lumotlar
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2 pt-2">
                <Label htmlFor="threshold" className="text-primary font-bold">
                ...
                <div className="flex items-center gap-4 bg-muted/20 p-3 rounded-lg border border-dashed">
                  ...
                  <span className="text-xs text-muted-foreground">
                    Mahsulot soni shundan kam bo'lsa, dashboardda ogohlantirish
                    chiqadi.
                  </span>
                </div>
              </div>
          ...
          <Card className="border shadow-sm bg-card">
            <CardHeader>
              ...
              <CardDescription>
                Mijozlarni jalb qilish va keshbek tizimi
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-3">
                <Label htmlFor="bonus" className="text-orange-700 font-bold">
                  Keshbek (Bonus) Foizi
                </Label>
                <div className="flex items-center gap-4 bg-orange-50/50 p-4 rounded-xl border border-orange-100">
                  <div className="relative w-32">
                    ...
                    />
                    <span className="absolute right-3 top-3.5 text-orange-600 font-bold text-xl">
                      %
                    </span>
                  </div>
                  <p className="text-sm text-orange-900/70 leading-relaxed font-medium">
                    Mijoz xarid qilganda, ushbu foiz miqdorida uning balansiga
                    bonus yoziladi.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <Label
                  htmlFor="debt_days"
                  className="text-rose-700 font-bold text-base"
                >
                  ...
                  <div className="relative w-32">
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          debt_reminder_days: parseInt(e.target.value) || 0,
                        })
                      }
                      className="h-14 pr-12 text-2xl font-black border-rose-200 focus-visible:ring-rose-500 text-rose-700 bg-white"
                    />
                    <span className="absolute right-3 top-4.5 text-rose-600 font-bold text-xs">
                      KUN
                    </span>
                  </div>
          ...
          <Card className="border shadow-sm bg-card">
            <CardHeader>
              ...
              <CardDescription>
                Chop etiladigan chek ma'lumotlari
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="border shadow-sm bg-card border-l-4 border-l-emerald-500">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
            ...
            <CardDescription>
              Baza zahira nusxasini boshqarish va xavfsizlik
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  <p className="text-sm font-semibold text-emerald-900 dark:text-emerald-100">
                    Avtomatik Zahiralash Faol
                  </p>
                  <p className="text-xs text-emerald-700/80 dark:text-emerald-400/80">
                    Sotuvlar va smena yopilishida tizim avtomatik ravishda nusxa
                    oladi.
                  </p>
                </div>
              </div>
